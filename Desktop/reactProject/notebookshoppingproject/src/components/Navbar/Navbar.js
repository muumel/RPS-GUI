...
const Navbar = () => {
    ...
    const [numProCart, setNumProCart] = useState(0);
                ...
                <ul className="navbar-nav ml-auto submenu">
                    ...
                    <li className="nav-item">
                        <NavLink className="nav-link" to="/login" exact>
                            <i className="fas fa-user"></i> <span className="hiddenText">Login</span>
                        </NavLink>
                    </li>
                    <li className="nav-item">
                        <NavLink className="nav-link" to="/shopping-cart" exact>
                            <i className="fas fa-shopping-cart"><span class="num-product-in-cart" >{numProCart}</span></i> <span className="hiddenText">Shopping Cart</span>
                        </NavLink>
                    </li>
